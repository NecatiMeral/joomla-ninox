...
/**
 * Methods supporting a list of Mapping records.
 *
 * @since  1.6
 */
class NinoxModelMappings extends \Joomla\CMS\MVC\Model\ListModel
{
	/**
	 * Constructor.
	 *
	...
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'joomla_prop', 'a.`joomla_prop`',
				'ninox_prop', 'a.`ninox_prop`',
			);
		}
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__ninox_mapping` AS a');
